...
describe AlertsController do
  ...
  let(:valid_attributes) { { "alertable_type" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved alert as @alert" do
        ...
        post :create, {:alert => { "alertable_type" => "invalid value" }}, valid_session
        assigns(:alert).should be_a_new(Alert)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested alert" do
        ...
        Alert.any_instance.should_receive(:update_attributes).with({ "alertable_type" => "MyString" })
        put :update, {:id => alert.to_param, :alert => { "alertable_type" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the alert as @alert" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Alert.any_instance.stub(:save).and_return(false)
        put :update, {:id => alert.to_param, :alert => { "alertable_type" => "invalid value" }}, valid_session
        assigns(:alert).should eq(alert)
      end
